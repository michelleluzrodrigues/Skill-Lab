...
<html lang="pt-BR">
    ...
    <form action="cal.php"  method="get"> 
        <div class="row">
            ...
            <div class="col"><label for="num3">Numero3</label>
            <input type="text" class="form-control" id="num3" name="num3"></div>
            <div class="col">
            <label for="num4">Numero4</label>
            <input type="text" class="form-control" id="num4" name="num4">
            </div>
            <div class="col">
            <label for="num5">Numero5</label>
